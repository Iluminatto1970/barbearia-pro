...
$metricCards = [
    ...
    [
        ...
        'value' => $metrics['assinaturas_suspensas'],
        'icon' => 'fa-ban',
        'color' => '#ef4444',
...
<div class="dashboard-grid">
    ...
    <section class="panel-card">
        ...
        <div class="box-body">
            <?php if (empty($planosResumo)): ?>
                <div class="p-3 text-muted">Nenhum plano encontrado.</div>
            <?php else: ?>
                <?php foreach ($planosResumo as $plano): ?>
                    <div class="plan-row">
                        <div>
